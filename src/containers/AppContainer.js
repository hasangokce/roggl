...
import { ColumnListNoneContainer } from '../containers/ColumnListNoneContainer'
        ...
        return (
            <div className="main">
                ...
                {this.state.columns.length === 0
                    ? <ColumnListNoneContainer onAddNewPage={this.addNewPage} />
                    : <ColumnListContainer columns={this.state.columns} onHandleContentChange={this.handleContentChange} onHandleTitleChange={this.handleTitleChange} onAddNewPage={this.addNewPage} onHandleDeletePage={this.handleDeletePage}></ColumnListContainer>}
            </div>
        )
    }
